...
export default class ProjectReceiptClaim extends React.Component {
  ...
  render() {
    ...
    const rejectBtn = this.queryParam.status === '60' || this.queryParam.status === '21' || this.queryParam.status === '40' ? <Button type="danger" onClick={this.handleReject}>拒绝</Button> : null
