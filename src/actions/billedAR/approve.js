...
const Search = ({pageInfo, glDate, glDates, custInfo, projectNos, contractNos, companyName, ...ext})=>({
  [httpApi]: {
    ...
    options: {
      ...
      body: {
        ...
        glDateStart: glDate[0].format('YYYY-MM-DD'),
        glDateEnd: glDate[1].format('YYYY-MM-DD'),
